...
public class MolarMassPanel extends JPanel {
    ...
    private void  initComponent() {
        ...
        getMolarMassButton.addActionListener(this::ml_mass_buttonActionPerformed);
        ...
        clearButton.addActionListener(this::ml_mass_clear_buttonActionPerformed);
    ...
    private void ml_mass_buttonActionPerformed(ActionEvent evt) {
        ...
        if (!compound_text.isEmpty()) {
            ...
            String[] table_header = new String[]{"Name", "Atomic mass"};
            String[][] table_row = Arrays.stream(atomList).map(atom -> new String[]{atom.getName(), String.valueOf(atom.getAtomicMass())}).toArray(String[][]::new);
            dataTableModel.setDataVector(table_row, table_header
            );

            compoundAnsLabel.setText(compound.getCompound());
    ...
    private void ml_mass_clear_buttonActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        errorMessagePanel.setVisible(false);
